...
public class SdsSwerveModule {
  ...
  public void simulationUpdate(
    ...
    driveMotorSim.iterate(driveRate, 12.0, Robot.defaultPeriodSecs);
    driveMotorSim.setPosition(drivePos);
    turningMotorSim.iterate(steerRateRot / Constants.kSteerGearRatio, 12.0, Robot.defaultPeriodSecs);
