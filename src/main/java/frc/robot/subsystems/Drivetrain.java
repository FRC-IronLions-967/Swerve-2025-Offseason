...
public class Drivetrain extends SubsystemBase {
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    Logger.recordOutput("Drive/ChassisSpeeds/xSpeed", xSpeed);
    Logger.recordOutput("Drive/ChassisSpeeds/ySpeed", ySpeed);
    Logger.recordOutput("Drive/ChassisSpeeds/Rotation", rot);
    ...
    Logger.recordOutput("Drive/Module0/SetAngle", swerveModuleStates[0].angle.getRadians());
    Logger.recordOutput("Drive/Module1/SetAngle", swerveModuleStates[1].angle.getRadians());
    Logger.recordOutput("Drive/Module2/SetAngle", swerveModuleStates[2].angle.getRadians());
    Logger.recordOutput("Drive/Module3/SetAngle", swerveModuleStates[3].angle.getRadians());

    Logger.recordOutput("Drive/Module0/SetVelocity", swerveModuleStates[0].speedMetersPerSecond);
    Logger.recordOutput("Drive/Module1/SetVelocity", swerveModuleStates[1].speedMetersPerSecond);
    Logger.recordOutput("Drive/Module2/SetVelocity", swerveModuleStates[2].speedMetersPerSecond);
    Logger.recordOutput("Drive/Module3/SetVelocity", swerveModuleStates[3].speedMetersPerSecond);
  }
  ...
  public void driveRobotRelative(ChassisSpeeds chassisSpeeds) {
    ...
    //Time slice discretization code taken from 254/YAGSL
    //Compensates for second order kinematic drift
    ChassisSpeeds.discretize(chassisSpeeds, Robot.defaultPeriodSecs); 
    var swerveModuleStates =
        Constants.m_kinematics.toSwerveModuleStates(chassisSpeeds);
    SwerveDriveKinematics.desaturateWheelSpeeds(swerveModuleStates, Constants.kMaxSpeed);
    m_frontLeft.setDesiredState(swerveModuleStates[0]);
  ...
  @Override 
    public void periodic(){
      ...
      Logger.recordOutput("Drive/Module0/ActualAngle", m_frontLeft.getWheelAngle());
      Logger.recordOutput("Drive/Module1/ActualAngle", m_frontRight.getWheelAngle());
      Logger.recordOutput("Drive/Module2/ActualAngle", m_backLeft.getWheelAngle());
      Logger.recordOutput("Drive/Module3/ActualAngle", m_backRight.getWheelAngle());
    
      Logger.recordOutput("Drive/Module0/ActualVelocity", m_frontLeft.getWheelVelocity());
      Logger.recordOutput("Drive/Module1/ActualVelocity", m_frontRight.getWheelVelocity());
      Logger.recordOutput("Drive/Module2/ActualVelocity", m_backLeft.getWheelVelocity());
      Logger.recordOutput("Drive/Module3/ActualVelocity", m_backRight.getWheelVelocity());

      Logger.recordOutput("Pose/Pose2d", getPose());
      Logger.recordOutput("Pose/Rotation", getPose().getRotation().getRadians());
  ...
  public void simulationPeriodic() {
      ...
      swerveDriveSim.update(Robot.defaultPeriodSecs);
